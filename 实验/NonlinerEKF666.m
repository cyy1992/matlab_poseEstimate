function [ x,P] = NonlinerEKF666(z,x,P,focalIndex,t,RelatObjCoor,N,flag)
...
elseif flag == 6
    ...
    if((prod(z1)==0)&&(prod(z2)==0))
        [ xd1,P11 ] = AEkfPredict(A_k,f,xd2,P11,Q);
        [ xd2,P22 ] = AEkfPredict(A_k,f,xd2,P22,Q);
        n1 = n1+1;
        n2 = n2+1;
        n11 = 1/n1;
        n22 = 1/n2;
        ...
        x = w1*xd1+w2*xd2;
    elseif (prod(z1)==0)
        [ xd1,P11 ] = AEkfPredict(A_k,f,xd1,P11,Q);
        H_k2 = ekf_jacobian83( f,xd2,2);
        [xd2,~,P22,~,~,qNk2,detNk2,Q2,qlast2] = AEkf(A_k,f,xd2,P22,h2,z2,Q2,R,qNk2,detNk2,N,qlast2,H_k2);
        n1 = n1+1;
        if(n2~=1)
            n2 = n2 -1;
        end
    ...
    elseif (prod(z2)==0)
        [ xd2,P22 ] = AEkfPredict(A_k,f,xd2,P22,Q);
        H_k1 = ekf_jacobian83( f,xd1,1);
        [xd1,~,P11,~,~,qNk1,detNk1,Q1,qlast1] = AEkf(A_k,f,xd1,P11,h1,z1,Q1,R,qNk1,detNk1,N,qlast1,H_k1);
        n1 = n1+1;
        if(n1~=1)
            n1 = n1 -1;
        end
